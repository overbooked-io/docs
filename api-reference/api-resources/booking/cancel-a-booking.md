---
description: Cancels the Booking and frees up the Slot.
---

# Cancel a Booking

{% api-method method="post" host="https://api.overbooked.io" path="/bookings/:booking\_id/cancel" %}
{% api-method-summary %}
...
{% code title="public.booking.cancel" %}
```javascript
{
  "data": {
    "_object": "booking",
...
const { data, error, meta, success } = await overbooked.booking.cancel(
  "21b2c36b-f458-4fce-b8fe-0ca48f8dcbe0"
)

console.log(data) // cancelled booking
```
{% endtab %}
{% endtabs %}
