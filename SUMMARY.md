...
* [Resources](api-reference/resources/README.md)
  * [Resource](api-reference/resources/resource/README.md)
    * [Create a Resource](api-reference/resources/resource/create-a-resource.md)
    * [List Resources](api-reference/resources/resource/list-resources.md)
    * [Get a Resource](api-reference/resources/resource/get-a-resource.md)
    * [Update a Resource](api-reference/resources/resource/update-a-resource.md)
    * [Publish a Resource](api-reference/resources/resource/publish-a-resource.md)
    * [Convert a Resource to draft](api-reference/resources/resource/convert-a-resource-to-draft.md)
  * [Slot](api-reference/resources/slot/README.md)
    ...
    * [Enable a Slot](api-reference/resources/slot/enable-a-slot.md)
    * [Disable a Slot](api-reference/resources/slot/disable-a-slot.md)
