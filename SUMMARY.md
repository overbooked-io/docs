...
* [API Resources](api-reference/api-resources/README.md)
  * [Resource](api-reference/api-resources/resource/README.md)
    * [Create a Resource](api-reference/api-resources/resource/create-a-resource.md)
    * [List Resources](api-reference/api-resources/resource/list-resources.md)
    * [Get a Resource](api-reference/api-resources/resource/get-a-resource.md)
    * [Update a Resource](api-reference/api-resources/resource/update-a-resource.md)
  ...
  * [Slot](api-reference/api-resources/slot/README.md)
    * [Add Slots](api-reference/api-resources/slot/add-slots.md)
    ...
    * [Enable a Slot](api-reference/api-resources/slot/enable-a-slot.md)
    * [Disable a Slot](api-reference/api-resources/slot/disable-a-slot.md)
    * [Lock a Slot](api-reference/api-resources/slot/lock-a-slot.md)
  ...
  * [Booking](api-reference/api-resources/booking/README.md)
    * [Untitled](api-reference/api-resources/booking/untitled.md)
